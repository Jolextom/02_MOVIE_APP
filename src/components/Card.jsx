...
const Card = ({
  ...
  return (
    ...
    >
      <Link to={`/movies/${id}`} className="space-y-2 relative">
        <div className="absolute top-0 left-0  flex p-4 justify-between  w-full items-center">
        ...
        <h3
          ...
          className="text-lg text-[#111827] font-bold leading-4"
        >
          {title}
        </h3>
